-- back compat for old kwarg name
    ...
    when matched then update set
        `DataHora` = DBT_INTERNAL_SOURCE.`DataHora`,`Venda` = DBT_INTERNAL_SOURCE.`Venda`,`Status` = DBT_INTERNAL_SOURCE.`Status`,`DataBaixa` = DBT_INTERNAL_SOURCE.`DataBaixa`,`FormaPagamento` = DBT_INTERNAL_SOURCE.`FormaPagamento`,`Funcionario` = DBT_INTERNAL_SOURCE.`Funcionario`,`NomeCliente` = DBT_INTERNAL_SOURCE.`NomeCliente`,`CodigoCliente` = DBT_INTERNAL_SOURCE.`CodigoCliente`,`CPF` = DBT_INTERNAL_SOURCE.`CPF`,`Sexo` = DBT_INTERNAL_SOURCE.`Sexo`,`CEP` = DBT_INTERNAL_SOURCE.`CEP`,`Endereco` = DBT_INTERNAL_SOURCE.`Endereco`,`Numero` = DBT_INTERNAL_SOURCE.`Numero`,`Bairro` = DBT_INTERNAL_SOURCE.`Bairro`,`Email` = DBT_INTERNAL_SOURCE.`Email`,`Celular` = DBT_INTERNAL_SOURCE.`Celular`,`NomeAnimal` = DBT_INTERNAL_SOURCE.`NomeAnimal`,`Especie` = DBT_INTERNAL_SOURCE.`Especie`,`SexoAnimal` = DBT_INTERNAL_SOURCE.`SexoAnimal`,`Raca` = DBT_INTERNAL_SOURCE.`Raca`,`TipoItem` = DBT_INTERNAL_SOURCE.`TipoItem`,`Grupo` = DBT_INTERNAL_SOURCE.`Grupo`,`ProdutoServico` = DBT_INTERNAL_SOURCE.`ProdutoServico`,`ValorUnitario` = DBT_INTERNAL_SOURCE.`ValorUnitario`,`Quantidade` = DBT_INTERNAL_SOURCE.`Quantidade`,`Bruto` = DBT_INTERNAL_SOURCE.`Bruto`,`Desconto` = DBT_INTERNAL_SOURCE.`Desconto`,`Liquido` = DBT_INTERNAL_SOURCE.`Liquido`,`Observacoes` = DBT_INTERNAL_SOURCE.`Observacoes`,`date` = DBT_INTERNAL_SOURCE.`date`
    

    when not matched then insert
        (`DataHora`, `Venda`, `Status`, `DataBaixa`, `FormaPagamento`, `Funcionario`, `NomeCliente`, `CodigoCliente`, `CPF`, `Sexo`, `CEP`, `Endereco`, `Numero`, `Bairro`, `Email`, `Celular`, `NomeAnimal`, `Especie`, `SexoAnimal`, `Raca`, `TipoItem`, `Grupo`, `ProdutoServico`, `ValorUnitario`, `Quantidade`, `Bruto`, `Desconto`, `Liquido`, `Observacoes`, `date`)
    values
        (`DataHora`, `Venda`, `Status`, `DataBaixa`, `FormaPagamento`, `Funcionario`, `NomeCliente`, `CodigoCliente`, `CPF`, `Sexo`, `CEP`, `Endereco`, `Numero`, `Bairro`, `Email`, `Celular`, `NomeAnimal`, `Especie`, `SexoAnimal`, `Raca`, `TipoItem`, `Grupo`, `ProdutoServico`, `ValorUnitario`, `Quantidade`, `Bruto`, `Desconto`, `Liquido`, `Observacoes`, `date`)
